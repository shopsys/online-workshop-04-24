...
/**
 * @ORM\Entity
 * @ORM\Table(name="article_product")
 */
class ArticleProduct
{
     ...
     */
    public function getArticle(): \Shopsys\ShopBundle\Model\Article\Article
    {
        return $this->article;
    }
     ...
     */
    public function getProduct(): \Shopsys\ShopBundle\Model\Product\Product
    {
        return $this->product;
    }
}
